...
class ObjectNaviThorBaseConfig(ObjectNavThorBaseConfig, ABC):
    ...
    #VAL_DATASET_DIR = os.path.join(os.getcwd(), "datasets/ithor-objectnav/train_sampled")
...
class ObjectNaviThorBaseConfigDebug(ObjectNavThorBaseConfig, ABC):
    """The base config for all iTHOR ObjectNav experiments."""
    ...
    TEST_DATASET_DIR = os.path.join(os.getcwd(), "datasets/ithor-objectnav/debug/")
