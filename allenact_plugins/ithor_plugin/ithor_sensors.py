...
class GPSCompassSensorIThor(Sensor[IThorEnvironment, PointNaviThorTask]):
    ...
    def _compute_pointgoal(
        ...
        direction_vector_agent = GPSCompassSensorIThor.quaternion_rotate_vector(
    ...
    def get_observation(
        self,
        env: IThorEnvironment,
        task: Optional[PointNaviThorTask],
        *args: Any,
        **kwargs: Any
    ) -> Any:
