...
def get_objectnav_ithor_default_resnet(episode_type,pretrained=False):
    ...
    from projects.tutorials.object_nav_ithor_ppo_baseline_longvisibility import ObjectNavThorPPOExperimentConfig
    # Define Task sampler 
...
def get_pointnav_ithor_default_resnet(episode_type,pretrained=False):
    ...
    from projects.tutorials.point_nav_ithor_ppo_baseline_dummy_target import PointNavThorPPOExperimentConfig
...
def get_pointnav_ithor_default_simpleconv(episode_type, pretrained=False):
    ...
    from projects.tutorials.point_nav_ithor_ppo_simpleconv_dummy_target import PointNavThorPPOExperimentConfig
...
def main():
    ...
    follower_model_ids = ["pointnav_ithor_default_" + args['arch'] + "_pretrained" ]
    save_dir = os.path.join('trajectory_metadata_pointnav_dummytarget',args['episode_type'],'active_human_sub1_trajectories_with_metadata')
    #print(save_dir)
