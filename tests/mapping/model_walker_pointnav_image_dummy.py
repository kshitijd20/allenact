...
def get_pointnav_ithor_default_resnet(episode_type,pretrained=False):
    ...
    from projects.tutorials.point_nav_ithor_ppo_baseline_dummy_image import PointNavThorPPOExperimentConfig
...
def get_pointnav_ithor_default_simpleconv(episode_type, pretrained=False):
    ...
    from projects.tutorials.point_nav_ithor_ppo_simpleconv_dummy_image import PointNavThorPPOExperimentConfig
...
def main():
    ...
    save_dir = os.path.join('trajectory_metadata_pointnav_dummyimage',args['episode_type'],'active_human_sub1_trajectories_with_metadata')
    #print(save_dir)
